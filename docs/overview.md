# mealie-mcp — Concept Overview

> **Category**: Lifestyle | **Ecosystem Role**: MCP Server + A2A Agent
...
```json
{
  "mcpServers": {
    "mealie-mcp": {
      "command": "uv",
      "args": ["run", "--with", "mealie-mcp", "mealie-mcp"],
      "env": {}
    }
  }
}
...
```bash
mealie-mcp --transport streamable-http --port 8001
```
