...
def usage():
    print(
        f"Mealie Mcp ({__version__}): Mealie MCP Server\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., mealie.read,mealie.write). ]\n"
