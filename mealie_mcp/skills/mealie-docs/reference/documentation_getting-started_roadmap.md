[ Skip to content ](https://docs.mealie.io/documentation/getting-started/roadmap/#development-road-map)
...
[ mealie-recipes/mealie
  ...
  * Getting Started
    ...
    * Road Map  [ Road Map  ](https://docs.mealie.io/documentation/getting-started/roadmap/)
      * [ Feature Requests  ](https://docs.mealie.io/documentation/getting-started/roadmap/#feature-requests)
    * Installation
