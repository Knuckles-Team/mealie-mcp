...
name: mealie-starter
description: >-
  Mealie API + MCP Server + A2A Server Use when working with Mealie via this package's MCP
...
license: MIT
tags: [mealie-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Mealie Starter Skill

Starter skill for the **Mealie** package. Use the `mcp-client` universal skill
