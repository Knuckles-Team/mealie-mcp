...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/mealie-mcp'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in mealie-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in mealie-mcp but are NOT registered "
